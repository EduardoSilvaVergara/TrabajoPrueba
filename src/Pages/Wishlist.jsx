  ...
  return (
    <>
      ...
      <div className="container my-5">
        <h2 className="text-center fw-bold mb-4">❤️ Tu Lista de Deseos</h2>
                  ...
                  <div className="card-body d-flex flex-column text-center">
                    ...
                    <div className="mt-auto d-flex justify-content-between gap-2">
                      <button className="btn w-100" onClick={() => addToCart(product)}>
                        <i className="ri-shopping-cart-2-line me-1">Agregar al carrito</i>
                      </button>
                      <button className="btn w-100" onClick={() => removeFromWishlist(product.id)}>
                        <i className="ri-shopping-cart-2-line me-1"> Remover </i>
                      </button>
                    </div>
                  </div>
                </div>
